...
#'   For statisticians: any of your favorite statistics books should cover confidence intervals ;-)\cr
...
ci <- function(
   ...
   digits=3)
{
warning("ci will be removed from berryFunctions in late 2017.")
